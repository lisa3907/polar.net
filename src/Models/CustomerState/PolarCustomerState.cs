...
namespace PolarNet.Models
{
    ...
    public class PolarCustomerState
    {
        ...
        public List<PolarCustomerStateSubscription> ActiveSubscriptions { get; set; } = new();

        /// <summary>
        /// Granted benefits for the customer.
        /// </summary>
        [JsonPropertyName("granted_benefits")]
        public List<PolarCustomerStateGrantedBenefit> GrantedBenefits { get; set; } = new();

        /// <summary>
        /// Active meters for the customer.
        /// </summary>
        [JsonPropertyName("active_meters")]
        public List<PolarCustomerStateActiveMeter> ActiveMeters { get; set; } = new();
    }
}