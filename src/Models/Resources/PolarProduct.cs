...
namespace PolarNet.Models
{
    ...
    public class PolarProduct
    {
        ...
        /// <summary>
        /// Whether the product is recurring (subscription).
        /// </summary>
        [JsonPropertyName("is_recurring")]
        public bool IsRecurring { get; set; }

        /// <summary>
        /// Recurring interval if recurring, e.g., monthly.
        /// </summary>
        ...
        /// <summary>
        /// Available prices for this product.
        /// </summary>
        [JsonPropertyName("prices")]
        public List<PolarPrice> Prices { get; set; } = new();

        /// <summary>
        /// Benefits granted by this product.
        /// </summary>
